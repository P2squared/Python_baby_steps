...
class Image:
    def __init__(self, x_pixels=0, y_pixels=0, num_channels=0, filename=''):
        ...
        self.input_path = 'C:/Users/LAMDA/PycharmProjects/Python_baby_steps/pyphotoshop-main/input/'
        self.output_path = 'C:/Users/LAMDA/PycharmProjects/Python_baby_steps/pyphotoshop-main/output/'
    ...
    def read_image(self, filename, gamma=2.2):
        ...
        '''
        im = pyPS_png.Reader(self.input_path + filename).asFloat()
